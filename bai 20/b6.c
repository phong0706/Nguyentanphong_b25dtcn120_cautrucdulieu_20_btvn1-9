...
int main() {
    ...
    if (currentCount < 50) {
        ...
        printf("Nhap ID: ");
        scanf("%d", &students[currentCount].id);
        
        getchar(); 

        printf("Nhap Ten: ");
        fgets(students[currentCount].name, sizeof(students[currentCount].name), stdin);
        students[currentCount].name[strcspn(students[currentCount].name, "\n")] = 0;
        ...
        students[currentCount].phoneNumber[strcspn(students[currentCount].phoneNumber, "\n")] = 0;
